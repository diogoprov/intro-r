...
## O alerta que abriu a discussão {.smaller}
...
## E o que os pesquisadores dizem {.smaller}
...
## O debate já era velho na ecologia {.smaller}
...
## O seu melhor colaborador {.smaller}
...
## Exercício 1 — do script ao documento {.smaller}

Peguem alguns dos scripts que usamos na semana e passem para Quarto:

::: {.incremental}
- explicando, em texto, o que cada trecho faz
- exibindo os gráficos gerados pelo próprio código
- compilando o resultado em **`.html`**
:::

## Exercício 2 — usando um LLM {.smaller}
