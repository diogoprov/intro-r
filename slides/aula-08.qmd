...
## O diagnóstico veio de dentro da área {.smaller}

::: {.incremental}
- Métodos e resultados relatados com detalhe insuficiente para interpretar ou
  para entrar numa meta-análise
- Muitos resultados simplesmente não são relatados — e os que ficam de fora
  são um **subconjunto enviesado**
- Logo, a conclusão que se tira da literatura publicada também é enviesada,
  e às vezes está inteiramente errada
:::

::: {.citacao}
Parker, T.H.; Forstmeier, W.; Koricheva, J.; Fidler, F.; Hadfield, J.D.;
Chee, Y.E.; Kelly, C.D.; Gurevitch, J.; Nakagawa, S. (2016).
**Transparency in Ecology and Evolution: Real Problems, Real Solutions.**
*Trends in Ecology & Evolution* 31(9): 711–719.
[doi:10.1016/j.tree.2016.07.002](https://doi.org/10.1016/j.tree.2016.07.002)
:::

## Dez anos depois, o gargalo é o código {.smaller}

Amostra aleatória de 346 artigos não moleculares de ecologia, publicados
entre 2015 e 2019 em revistas que já exigiam ou encorajavam compartilhar
código.

::: {.incremental}
- **Dados** disponíveis em 79% dos artigos elegíveis
- **Código** disponível em 27%
- Revistas de ecologia com política de código: 15% em 2015, 75% em 2020.
  A política veio; a adesão, não
:::
...
[doi:10.1371/journal.pbio.3000763](https://doi.org/10.1371/journal.pbio.3000763)
:::
...
## Os mesmos dados, 174 análises {.smaller .diagrama-menor}

174 equipes de análise — 246 analistas — receberam dois conjuntos de dados
inéditos e a mesma pergunta. **A**: irmãos e crescimento dos ninhegos em
*Cyanistes caeruleus* (141 efeitos). **B**: gramíneas e recrutamento de
*Eucalyptus* (85 efeitos).

![](img/a08-gould-2025.png){width=78%}

::: {.citacao}
Figura 2 de Gould, E.; Fraser, H.S.; Parker, T.H.; Nakagawa, S. *et al.* (2025).
**Same data, different analysts.** *BMC Biology* 23: 35.
[doi:10.1186/s12915-024-02101-x](https://doi.org/10.1186/s12915-024-02101-x)
— CC BY.
:::

## O que essa figura quer dizer {.smaller}

::: {.incremental}
- Em **A** o efeito médio é convincentemente negativo, mas as estimativas vão
  de fortemente negativas até perto de zero — e algumas cruzam o limiar de
  significância no sentido **oposto**
- Em **B** a média mal se distingue de zero, e cerca de um terço dos efeitos
  cruza o limiar de significância — para um lado ou para o outro
- Análises longe da média não usaram variáveis mais esquisitas, nem efeitos
  aleatórios diferentes, nem receberam notas piores na revisão por pares.
  **Não dá para separar a "análise errada" pela forma dela**
:::
...
## Onde essa conversa acontece {.smaller}

::: {.incremental}
- **SORTEE** — Society for Open, Reliable, and Transparent Ecology and
  Evolutionary biology. Criada por pesquisadores da própria área e apresentada
  em 2021, com conferência anual e grupos de trabalho —
  [sortee.org](https://www.sortee.org/)
- **EcoEvoRxiv** — o servidor oficial de preprints da SORTEE, para ecologia e
  evolução — [ecoevorxiv.org](https://ecoevorxiv.org/)
- **FORRT** — Framework for Open and Reproducible Research Training. Material
  pronto para ensinar ciência aberta na graduação e na pós —
  [forrt.org](https://forrt.org/)
:::

::: {.citacao}
O'Dea, R.E.; Parker, T.H.; Chee, Y.E.; Culina, A.; Drobniak, S.M.;
Duncan, D.H.; Fidler, F.; Gould, E. *et al.* (2021).
**Towards open, reliable, and transparent ecology and evolutionary biology.**
*BMC Biology* 19: 68.
[doi:10.1186/s12915-021-01006-3](https://doi.org/10.1186/s12915-021-01006-3)
:::
...
## O ecossistema {.smaller .diagrama-menor}
...
<!-- A linhagem, na faixa livre embaixo. São `.absolute` de propósito: em
     fluxo normal a fileira somaria uns 110px e o slide estouraria os 700px
     do palco. As medidas são em px do palco (1050x700). -->
![](img/hex-rmarkdown.png){.absolute top=582 left=0 width=96}
![](img/hex-knitr.png){.absolute top=582 left=108 width=96}
![](img/hex-quarto.png){.absolute top=582 left=216 width=96}
...
<!-- .nostretch: sem isso o Quarto marca a imagem com .r-stretch e o
     revealjs escreve width e height fixos nela. O max-width do .fim
     corta só a largura e o logotipo sai achatado. -->
![](img/lsb-logo.png){.nostretch width="62%"}
