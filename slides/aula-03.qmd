...
```{mermaid}
%%| fig-width: 8
%%{init: {"flowchart": {"htmlLabels": false, "padding": 12, "nodeSpacing": 34, "rankSpacing": 55}, "themeVariables": {"fontSize": "16px"}}}%%
flowchart LR
  WD["Working directory"] -- "add" --> ST["Stage"]
  ST -- "commit" --> LR["Local repository"]
  LR -- "push" --> RR["Remote repository"]
  RR -- "fetch" --> LR
  RR -- "pull" --> WD
  LR -- "checkout" --> WD
```
...
<!-- TODO: um screenshot do painel Git do RStudio com 2 ou 3 arquivos
     modificados cairia muito bem aqui. Tire com o proprio repo da
     disciplina aberto e salve como slides/img/a03-rstudio-git.png,
     que eu ponho no lugar deste TODO. -->
